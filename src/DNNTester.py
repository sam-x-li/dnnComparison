...
'''
    ...
    Trains the 4-layer DNN on differently sized, randomly sampled training sets, and then runs it on the testing set. 
...
def main():
    ...
    for i in info:
        trainingrange, successes, accuracy, timetaken = i
        print(f'Training set size (n): {trainingrange} Accuracy: {accuracy} Time taken/s: {timetaken} Testing set size: {len(test_data)} Number of successes: {successes}')
